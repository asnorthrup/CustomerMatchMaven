...
public class ExcelWorkbookTest {
	...
	public void testWriteOutWorkbook() {
		CustomerObj co = new CustomerObj("C12897","John John", "Albert Cash SALE", "03445", "101 Main Street", "704-444-1283", "12777-233");
		co.setMatchScore(91);
		CustomerObj co1 = new CustomerObj("$23445","John John", "Albert Cash SALE", "903445", "101 Main Street", "704-445-5583", "12345-233");
		co1.setMatchScore(94);
		CustomerObj co2 = new CustomerObj("M5000","Duke Energy", " Cash SALE", "012335", "PO BOX 50", "704-574-4483", "97865-233");
