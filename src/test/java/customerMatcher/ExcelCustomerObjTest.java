...
public class ExcelCustomerObjTest {
	...
	public void setUp() throws Exception {
		co = new CustomerObj("M23456","John John", "DBA JJ's Trucking", null, "101 Main Street", "704-444-4483", "12345");
		co.setMatchScore(80.1);
		co1 = new CustomerObj("C54321","Alan's Shop", null, "54321", "1111 Trade Street", "704-555-5555", "12345");
		co1.setMatchScore(99.1);
		co2 = new CustomerObj("M23456","John Allan D/B/A New Era Farms", null, null, "101 Main Street", "704-444-1000", "12345");
