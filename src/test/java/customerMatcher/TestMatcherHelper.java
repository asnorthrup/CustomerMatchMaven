...
public class TestMatcherHelper {
	...
	public void setUp() throws Exception {
		...
		co3 = new CustomerObj(null,"JJ D ump T ruc Service", null, null, "PO Box", null, "12345");
		co4 = new CustomerObj(null,"JA Truck Shop", null, null, "1111 Trade Street", null, "12345");	
		co5 = new CustomerObj(null,"Truck Stop Inc.", null, null, "101 Main Street", null, "12345");
