...
public class ProgressBar extends JFrame {
	...
	private void initComponents() {
		...
		//pbGenMatches.setAlignmentY(Component.BOTTOM_ALIGNMENT);
		pbImportDBS = new JProgressBar();
		//pbImportDBS.setAlignmentY(Component.TOP_ALIGNMENT);
		JLabel lblImportDBSStatus = new JLabel("Importing DBS Customers...");
		JLabel lblGenMatchStatus = new JLabel("Generating Matches...");
		//lblGenMatchStatus.setAlignmentY(Component.BOTTOM_ALIGNMENT);
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(99)
					.addComponent(pbImportDBS, GroupLayout.PREFERRED_SIZE, 247, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(163)
					.addComponent(lblGenMatchStatus))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(99)
					.addComponent(pbGenMatches, GroupLayout.PREFERRED_SIZE, 247, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(178)
...
//		pbReadWBofUnknownCusts.update(pbReadWBofUnknownCusts.getGraphics());
	...
	/**
	 * @return the pbImportDBS
	 */
	public JProgressBar getPbImportDBS() {
		return pbImportDBS;
	}

	/**
	 * @return the pbReadWBofUnknownCusts
	 */
	public JProgressBar getPbReadWBofUnknownCusts() {
	//	return pbReadWBofUnknownCusts;
		return null;
	}

	/**
	 * @return the pbGenMatches
	 */
	public JProgressBar getPbGenMatches() {
		return pbGenMatches;
	}
